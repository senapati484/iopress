#!/bin/bash
#
# expressmax Valgrind Memory Check
#
...
echo "=== expressmax Valgrind Memory Check ==="
echo ""
...
cat > /tmp/expressmax-valgrind-server.js << 'EOF'
...
valgrind \
    ...
    node --expose-gc /tmp/expressmax-valgrind-server.js &
...
# Cleanup
rm -f /tmp/expressmax-valgrind-server.js
