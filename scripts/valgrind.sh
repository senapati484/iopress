...
echo "=== norvex Valgrind Memory Check ==="
echo ""
...
cat > /tmp/norvex-valgrind-server.js << 'EOF'
...
valgrind \
    ...
    node --expose-gc /tmp/norvex-valgrind-server.js &
...
# Cleanup
rm -f /tmp/norvex-valgrind-server.js
