...
async function checkGitHubReleases(pkg) {
  ...
  const repoUrl = pkg.binary?.host_path || 'https://github.com/senapati484/express-pro';
...
function generateReport() {
  ...
  log('     npm install express-pro --build-from-source=false');
  log('');
}
